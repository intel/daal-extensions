...
def max_pool1d(x):
    # MaxPool2D wrapper
    return tf.nn.pool(x, window_shape=[2], strides=[2], padding='VALID', pooling_type='MAX')

def avg_pool1d(x):
    # MaxPool2D wrapper
    return tf.nn.pool(x, window_shape=[2], strides=[2], padding='VALID', pooling_type='AVG')
